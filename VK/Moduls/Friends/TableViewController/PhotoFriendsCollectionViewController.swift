...
class PhotoFriendsCollectionViewController: UICollectionViewController {
    ...
    private var photos = [PhotoFriend]()
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "photoFriendCell", for: indexPath) as? PhotoFriendCollectionViewCell else {return UICollectionViewCell()}
